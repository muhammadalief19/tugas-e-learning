...
<div class="h-screen md:flex">
	<div
		...
		<div>
			<h1 class="text-white font-bold text-4xl font-sans">E-Leaning</h1>
			<p class="text-white mt-1">Silahkan mendaftar terlebih dahulu, sebelum masuk ke aplikasi E-Learning PENS</p>
		</div>
